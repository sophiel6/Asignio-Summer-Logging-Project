...
namespace AsignioInternship.Data.LogInfo
{
    public class LogInfoRepository : BaseRepository, ILogInfoRepository
    {
        ...
        public PagedDataModelCollection<CombinedLogInfoDataModel> CombinedPageLogInfo(int pageSize, int pageNumber, string sortColumn, string sortDirection, Dictionary<string,string> searchDictionary)
        {
